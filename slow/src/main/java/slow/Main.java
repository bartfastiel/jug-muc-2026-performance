...
void main() throws IOException {
    var csvFile = extractZipFile("personal-data_1000.zip");
...
Path extractZipFile(String inputFile) throws IOException {
...
Collection<Person> parse(Path csvFile) throws IOException {
...
Person findPersonWithMostCommonBirthday(Collection<Person> persons) {
...
long numberOfPersonsThatCelebrate(Collection<Person> persons, MonthDay birthday) {
    return persons.stream()
